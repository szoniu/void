...
All tests are standalone — they do not require root or hardware. They use `DRY_RUN=1` and `NON_INTERACTIVE=1`. The full suite is 17 functional files (527 assertions) + `shellcheck.sh` (lints all 65 `.sh` files; needs `shellcheck` installed).
